...
import com.example.tfg.BBDD.Dao.CategoriasDao
...
@Database(entities = arrayOf(Usuario_tabla::class, Cuenta_tabla::class, Usuario_Cuenta_tabla::class, Transaccion_tabla::class, Categoria_tabla::class), version = 1) //Categorias_Genericas_tabla::class), version = 1)
